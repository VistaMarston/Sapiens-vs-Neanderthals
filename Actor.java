...
public class Actor extends Sprite implements Attack {
	...
	/** Changes the speed of any actor in the game
	 * @param newSpeed a double that represents the speed of the actor
	 */
	...
	/**
	 * Retrieves the Cool Down Timer for the actor
	 * @return an integer that is the cool down timer
	 */
